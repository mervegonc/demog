              ...
              <div className="profile-ones-post-panel">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  {isAuthenticatedUser(userId) && (
                    <img src={PostOptionIcon} className="post-option-button" alt="Options" onMouseEnter={() => handleMouseEnterArticleOption(article.id)} onMouseLeave={() => handleMouseLeaveArticleOption(article.id)} />
                  )}
                </div>
                {article.isPanelOpen && (
                  <div className="post-option-panel" onMouseEnter={() => handleMouseEnterArticleOption(article.id)} onMouseLeave={() => handleMouseLeaveArticleOption(article.id)}>
                    {isAuthenticatedUser(userId) && (
                      <React.Fragment>
